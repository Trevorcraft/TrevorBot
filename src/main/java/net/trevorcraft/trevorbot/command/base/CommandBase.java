package net.trevorcraft.trevorbot.command.base;
...
public class CommandBase implements CommandExecutor, TabCompleter {
  ...
  public static void sendMessage(CommandSender sender, String message) {
    sender.sendMessage(ChatColor.DARK_GREEN + "TrevorBot> " + ChatColor.GREEN + message);
  }
  ...
  private List<String> subCommandCompletions(Player player, String arg) {
    ...
    for (String subcommandName : subCommands.keySet()) {
      // Don't show the default command in the list
      if (subcommandName.equals("default")) continue;
